            ...
            <div class="card mt-2">
                ...
                <div class="card-body">
                    <div class="row mb-4 text-center">
                            ...
                            <button type="button" class="btn col btn-warning mr-1" @if($jornadaFinalizada) hidden @endif style="height: 4em;"  id="IniciarDescansoButton">Iniciar Descanso</button>
                            <button type="button" class="btn col btn-success" @if($jornadaFinalizada) hidden @endif style="height: 4em;" id="FinalizarJornadaButton">Finalizar Jornada</button>
                    </div>
