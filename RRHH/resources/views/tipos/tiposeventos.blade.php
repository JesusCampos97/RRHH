            ...
            <div class="card mt-2">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="tab-tipos-eventos-activos" data-toggle="pill" href="#tab-tipo-eventos-activos-tab" role="tab" aria-controls="custom-content-below-home" aria-selected="true">Tipos de eventos activos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="tab-tipos-eventos-no-activos" data-toggle="pill" href="#tab-tipo-eventos-no-activos-tab" role="tab" aria-controls="custom-content-below-profile" aria-selected="false">Tipos de eventos no activos</a>
                        </li>
                    </ul>

                    <div class="tab-content" id="custom-content-below-tabContent">
                        <div class="tab-pane fade active show" id="tab-tipo-eventos-activos-tab" role="tabpanel" aria-labelledby="tab-tipos-eventos-activos">
                        ...
                        <div class="tab-pane fade" id="tab-tipo-eventos-no-activos-tab" role="tabpanel" aria-labelledby="tab-tipos-eventos-no-activos">
                            <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                <div class="row">
                                    <div class="col-sm-12">
...
<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createTitle" aria-hidden="true" style="padding-right:0px">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="min-width: 650px">
            ...
            <div class="modal-body" style=" margin-top: -2em;">
                ...
                <form action="" method="POST" name="createTipoEvento" id="createTipoEvento">
                    @csrf
                    <hr>
 ...
 <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateTitle" aria-hidden="true">
    ...
    <div class="modal-content"  style="min-width: 650px">
        <div class="modal-header">
        <h1>Actualizar Tipo de Evento</h1>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteTitle" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h1>Desactivar Tipo de Evento</h1>
            <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
        ...
        <div class="modal-body" style="margin-top:-2em">
            ...
            <form method="POST"> 
                ...
                <div class="container" >
                  <div class="form-group">
                    <p>¿Deseas marcar como inactivo al tipo de evento?</p> 
                  </div>                     
    ...
    <div class="modal-content">
        ...
        <div class="modal-body" style="margin-top:-2em">
            ...
            <form method="POST"> 
                ...
                <div class="container" >
                  <div class="form-group">
                    <p>¿Deseas volver a activar el tipo de evento?</p> 
                  </div>                     
...
<script>
    ...
    $(document).ready( function () {
        ...
        var datatable = $('#table_id').DataTable({
            ...
            responsive: true,
            columns: [{ data: "nombre", title: "Nombre" }, { data: "color_evento", title: "Color" }],
        });
        ...
        $('#table_id tbody').on('click', 'tr', function () {
            ...
            $.ajax({
                ...
                success: function(dataResult){
                    ...
                    document.getElementById('colorEditar').value=dataJson[0]["color_evento"];
        ...
        $("#NoActivoButton").click(function(){
            $.ajax({
                url: "{{route('activadesactivaTiposEventos')}}",
                type: "POST",
                cache: false,
                data:{
                    _token:'{{ csrf_token() }}',
        ...
        $("#insertDataButton").click(function(e){
            var formulario = $('#createTipoEvento');
