            ...
            <div class="card mt-2">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="tab-tipos-incidentes-activos" data-toggle="pill" href="#tab-tipo-incidentes-activos-tab" role="tab" aria-controls="custom-content-below-home" aria-selected="true">Tipos de incidentes activos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="tab-tipos-incidentes-no-activos" data-toggle="pill" href="#tab-tipo-incidentes-no-activos-tab" role="tab" aria-controls="custom-content-below-profile" aria-selected="false">Tipos de incidentes no activos</a>
                        </li>
                    </ul>
                    <div class="tab-content" id="custom-content-below-tabContent">
                        <div class="tab-pane fade active show" id="tab-tipo-incidentes-activos-tab" role="tabpanel" aria-labelledby="tab-tipos-incidentes-activos">
                        ...
                        <div class="tab-pane fade" id="tab-tipo-incidentes-no-activos-tab" role="tabpanel" aria-labelledby="tab-tipos-incidentes-no-activos">
                            <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                <div class="row">
                                    <div class="col-sm-12">
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteTitle" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h1>Desactivar Tipo de Incidentes</h1>
            <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
        ...
        <div class="modal-body" style="margin-top:-2em">
            ...
            <form method="POST"> 
                ...
                <div class="container" >
                  <div class="form-group">
                    <p>¿Deseas marcar como inactivo al tipo de incidente?</p> 
                  </div>                     
...
<div class="modal fade" id="updateModal_NoActivo" tabindex="-1" role="dialog" aria-labelledby="updateModal_NoActivo" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h1>Activar Tipo de Incidentes</h1>
            <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
        ...
        <div class="modal-body" style="margin-top:-2em">
            ...
            <form method="POST"> 
                ...
                <div class="container" >
                  <div class="form-group">
                    <p>¿Deseas volver a activar el tipo de incidente?</p> 
                  </div>                     
...
<script>
    ...
    $(document).ready( function () {
        ...
        $("#NoActivoButton").click(function(){
            $.ajax({
                url: "{{route('activadesactivaTiposIncidentes')}}",
                type: "POST",
                cache: false,
                data:{
                    _token:'{{ csrf_token() }}',
